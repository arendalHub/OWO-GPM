...
<div class="panel">
    <div class="panel-heading">
        ...
        @endif
        <a
            href="{{url('/stock/fournisseur/list')}}"
    ...
    <div class="panel-body">
        <div class="example-box-wrapper">
            <form
                ...
                method="POST"
                action="{{url('/stock/fournisseur/do_create_update')}}"
                id="demo-form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input
                                    ...
                                    placeholder="Numero d'Identification Fiscale fournisseur"
                                    type="text"
                                />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input
                                    ...
                                    placeholder="Personne ressource du fournisseur"
                                    type="text"
                                />
                            </div>
                        </div>
