                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input
                                 value="@if(($fournisseur != null && $update)){{$fournisseur->raison_sociale}}@else{{old('raison_sociale')}}@endif"
                                 class="form-control"
                                 name="raison_sociale"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Désignation fournisseur</label>
                            <div class="col-sm-6">
                                <input
