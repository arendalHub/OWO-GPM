...
<div class="panel">
    <div class="panel-heading">
        ...
        @endif
        <a href="{{url('/stock/entree/list')}}" class="btn btn-primary">Retour sur la liste</a>
    </div>
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="{{url('/stock/entree/do_create_update')}}" class="form-horizontal bordered-row" id="demo-form" data-parsley-validate>
                    <fieldset>
                    ...
                    <fieldset>
                        <legend>Information complémentaire (N° Facture / Bordereau)</legend>
                        <div class="form-group">
                            <input type="text"  name="num_b_f" class="form-control">
                        </div>
                    </fieldset>
                    <fieldset>
