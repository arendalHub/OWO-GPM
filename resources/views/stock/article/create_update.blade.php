                    ...
                    <fieldset>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input required type="number" value="@if(($item != null && $update)) {{$item->seuil_alert}}@else {{old('seuil_alert')}} @endif" name="seuil_alert" placeholder="Saisir une valeur d'alerte de quantité en stock" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Valeur du seuil critique</label>
                                <div class="col-sm-6">
                                    <input required type="number" value="@if(($item != null && $update)) {{$item->seuil_critique}}@else {{old('seuil_critique')}} @endif" name="seuil_critique" placeholder="Saisir une valeur critique de quantité en stock" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
